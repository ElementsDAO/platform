...
const IOTA: AddEthereumChainParameter['nativeCurrency'] = {
  name: 'IOTA',
  symbol: 'IOTA',
  decimals: 18,
}
...
export const CHAINS: {
  ...
  // IOTA Smart Contract EVM
  1074: {
    urls: ['https://evm.wasp.sc.iota.org'].filter((url) => url !== undefined),
    name: 'IOTA EVM Testnet',
    nativeCurrency: IOTA,
    blockExplorerUrls: ['https://explorer.wasp.sc.iota.org/'],
  },
  80001: {
    urls: [
      process.env.infuraKey
